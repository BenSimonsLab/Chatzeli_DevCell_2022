...
% in the salivary gland at E18.5 for the confetti and kras samples.
%
% Inputs:
...
% (column 3), and  for the confetti the inner and outer widths of the 
%  corresponding duct (columns 4-5).
%
% node_positions: Array of size number_of_nodes*4. Column 1: node id. 
% Columns 2-4: coordinates (x,y,z) for each node, respectively, in pixels.
%
